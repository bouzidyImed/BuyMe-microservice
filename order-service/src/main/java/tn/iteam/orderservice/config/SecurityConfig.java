    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/api/orders/**").permitAll()  // Allow public access to categories (GET/POST/PUT/DELETE)
                        .requestMatchers("/api/products/**").permitAll()  // Allow public access to categories (GET/POST/PUT/DELETE)
